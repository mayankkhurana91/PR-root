...
plugin.tx_pingreceive_information {
    view {
        templateRootPaths.0 = EXT:pingreceive/Resources/Private/Templates/
        templateRootPaths.1 = {$plugin.tx_pingreceive_information.view.templateRootPath}
        partialRootPaths.0 = EXT:pingreceive/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_pingreceive_information.view.partialRootPath}
        layoutRootPaths.0 = EXT:pingreceive/Resources/Private/Layouts/
...
plugin.tx_pingreceive._CSS_DEFAULT_STYLE (
    ...
    .tx-pingreceive table {
        border-collapse:separate;
        border-spacing:10px;
    }

    .tx-pingreceive table th {
        font-weight:bold;
    }

    .tx-pingreceive table td {
        vertical-align:top;
    }
